 ...
 * 
 */
App.controller("CompetitionsController", [
	'$scope',
	'$rootScope',
	'$routeParams',
	'$compile',
	...
	function($scope, $rootScope, $routeParams,
			...
			DTColumnDefBuilder) {
		$rootScope.pageTitle = "Competitions";
		...
		$scope.dtOptions = {
				serverSide : true,
				sAjaxDataProp : 'data',
				ajax : '/api/competitionsDataTable',
				dom : '<"' + toolbar_prefix
		...
		$scope.dtColumns = [
				...
				DTColumnBuilder.newColumn(null).withTitle('Actions').notSortable()
		            .renderWith(function(data, type, full, meta) {
		                return '<a href="#/competitions/' + data.id + '"><img src="images/edit.png" class="action-button" title="editer"/></a>'
