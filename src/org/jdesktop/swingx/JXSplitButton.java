...
public class JXSplitButton extends JButton implements SwingConstants {
	...
	public JXSplitButton(String text, Icon icon, JPopupMenu dropDownMenu) {
		...
		super.getModel().addChangeListener(
	...
	private void arrowLabelMouseClicked(java.awt.event.MouseEvent evt) {
		if (dropDownMenu != null) {
			...
			if (UIManager.getLookAndFeel().getName() == "Windows") { //$NON-NLS-1$
				height--;
			}
			dropDownMenu
			...
			e = new ActionEvent(JXSplitButton.this,
					ActionEvent.ACTION_PERFORMED, super.getActionCommand(), evt
							.getWhen(), evt.getModifiers());
	...
	public Dimension getPreferredSize() {
		...
		if ((icon == null)
			...
			SwingUtilities.layoutCompoundLabel(this, fm, text, icon, super
					.getVerticalAlignment(), super.getHorizontalAlignment(),
					super.getVerticalTextPosition(), super
