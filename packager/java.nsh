...
Function GetJRE
    IfFileExists "jre-7u7-windows-i586.exe" lbl_NoDownloadRequired lbl_DownloadRequired
	
    lbl_NoDownloadRequired:
      ExecWait jre-7u7-windows-i586.exe
      GoTo done
	...
	StrCpy $2 "$TEMP\jre-7u7-windows-i586.exe"
