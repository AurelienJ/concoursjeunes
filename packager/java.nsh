...
Function GetJRE
    IfFileExists "jre-8u25-windows-i586.exe" lbl_NoDownloadRequired lbl_DownloadRequired
	
    lbl_NoDownloadRequired:
      ExecWait jre-8u25-windows-i586.exe
      GoTo done
	...
	StrCpy $2 "$TEMP\jre-8u25-windows-i586.exe"
