...
Function GetJRE
    IfFileExists "jre-8u111-windows-i586.exe" lbl_NoDownloadRequired lbl_DownloadRequired
	
    lbl_NoDownloadRequired:
      ExecWait jre-8u111-windows-i586.exe
      GoTo done
	...
	StrCpy $2 "$TEMPjre-8u111-windows-i586.exe"
