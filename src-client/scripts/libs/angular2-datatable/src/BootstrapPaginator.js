System.register(["@angular/core", "./DataTable", "lodash"], function (exports_1, context_1) {
    "use strict";
    ...
    var core_1, DataTable_1, _, BootstrapPaginator;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function () {
            ...
            exports_1("BootstrapPaginator", BootstrapPaginator);
        }
    };
});
