System.register(["@angular/core", "./Criterion"], function (exports_1, context_1) {
    "use strict";
    ...
    var core_1, Criterion_1, CriterionComponent;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function () {
            ...
            exports_1("CriterionComponent", CriterionComponent);
        }
    };
});
