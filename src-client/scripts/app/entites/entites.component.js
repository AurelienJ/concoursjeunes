System.register(["@angular/core", "@angular/router", "./entites.service", "../general"], function (exports_1, context_1) {
    "use strict";
    ...
    var core_1, router_1, entites_service_1, general_1, EntiteServerSideInputData, EntiteServerSideInputDataFilterPipe, EntitesComponent;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function () {
            ...
            EntitesComponent = (function () {
                ...
                EntitesComponent.prototype.ngOnInit = function () {
                    ...
                    this.entitesService.getTypeEntite().then(function (ta) { return _this.typesEntities = ta; });
                };
            ...
            exports_1("EntitesComponent", EntitesComponent);
        }
    };
});
