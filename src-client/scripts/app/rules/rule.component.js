System.register(["@angular/core", "@angular/router", "../references/references.service", "./rules.service", "../general", "./Rule"], function (exports_1, context_1) {
    "use strict";
                    ...
                    this.route.params.subscribe(function (params) {
                        ...
                        if (currentNavigationSnapshot
                            ...
                            if (_this.idRule != "new") {
                                ...
                                currentNavigationSnapshot.label = _this.rule.name;
