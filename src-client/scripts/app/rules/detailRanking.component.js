...
var DetailRankingComponent = /** @class */ (function () {
        ...
        for (var propName in changes) {
            if (propName == 'idFederation') {
                ...
                if (!this.rankingCriterion.distancesAndFacesSet && this.rankingCriterion.idDistancesAndFacesSet) {
                    this.rankingCriterion.distancesAndFacesSet = _.find(this.distanceAndFacesSets, function (df) { return df.id == _this.rankingCriterion.idDistancesAndFacesSet; });
                }
            }
        }
    };
    DetailRankingComponent.prototype.getCriterionElement = function (idCriterionElement) {
        for (var i = 0; i < this.criteria.length; i++) {
            ...
            var element = _.find(criterion.criterionElements, function (e) { return e.id == idCriterionElement; });
            if (element)
    ...
    DetailRankingComponent.prototype.deleteDiscriminantCriterionSet = function (discriminantCriterionSet) {
        _.remove(this.rankingCriterion.discriminantCriterionSets, function (e) { return e == discriminantCriterionSet; });
    };
    __decorate([
        Input(),
    ...
    DetailRankingComponent = __decorate([
        ...
        __metadata("design:paramtypes", [RulesService, EntitesService])
    ], DetailRankingComponent);
    return DetailRankingComponent;
}());
export { DetailRankingComponent };
