System.register(["@angular/core", "lodash"], function (exports_1, context_1) {
    ...
    var core_1, lodash_1, DistancesAndFacesComponent;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function () {
            DistancesAndFacesComponent = (function () {
                ...
                DistancesAndFacesComponent.prototype.deleteDistanceAndFacesSet = function (distanceAndFacesSet, confirmation) {
                    ...
                    if (!confirmation)
                        ...
                        lodash_1.default.remove(this.distancesAndFacesSet, function (df) { return df == distanceAndFacesSet; });
            ...
            exports_1("DistancesAndFacesComponent", DistancesAndFacesComponent);
        }
    };
});
