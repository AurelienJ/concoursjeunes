...
var RulesModule = /** @class */ (function () {
    ...
    RulesModule = __decorate([
        core_1.NgModule({
            imports: [router_1.RouterModule, platform_browser_1.BrowserModule, forms_1.FormsModule, datatable_1.DataTableModule, ngx_order_pipe_1.OrderModule, general_module_1.GeneralModule,
