System.register(["@angular/core", "@angular/router", "@angular/platform-browser", "@angular/forms", "../../libs/angular2-datatable", "../general", "../references/references.module", "./rules.service", "./rules.component", "./rule.component"], function (exports_1, context_1) {
    "use strict";
    ...
    var core_1, router_1, platform_browser_1, forms_1, angular2_datatable_1, general_1, references_module_1, rules_service_1, rules_component_1, rule_component_1, RulesModule;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
