System.register(["@angular/core", "@angular/common", "@angular/router", "./NavigationSnapshot", "rxjs/add/operator/filter"], function (exports_1, context_1) {
    "use strict";
    ...
    var core_1, common_1, router_1, NavigationSnapshot_1, NavigatorService;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
