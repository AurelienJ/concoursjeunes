System.register(["@angular/core", "@angular/router", "../references/references.service", "./persons.service", "../general", "rxjs/add/operator/share", "moment"], function (exports_1, context_1) {
    "use strict";
    ...
    var core_1, router_1, references_service_1, persons_service_1, general_1, moment, PersonComponent;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
