System.register(["@angular/core", "@angular/router", "./persons.service", "../general/navigator.service"], function (exports_1, context_1) {
    "use strict";
    ...
    var core_1, router_1, persons_service_1, navigator_service_1, PersonServerSideInputData, PersonServerSideInputDataFilterPipe, PersonsComponent;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function () {
            ...
            exports_1("PersonsComponent", PersonsComponent);
        }
    };
});
