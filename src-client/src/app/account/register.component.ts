...
@Component({
    ...
    <div class="register-box-body">
      <p class="login-box-msg"><img src="assets/images/fnd.jpg" style="width: 128px;"/><br/>Création d'un compte ArcCompetition</p>
            ...
            <div class="checkbox icheck">
              <label>
                <input icheck type="checkbox"
                  ...
                  /> j'accepte les <a href="assets/cgu.html">conditions d'utilisation</a>
              </label>
            </div>
          </div>
          <!-- /.col -->
...
export class RegisterComponent implements OnInit {
    ...
    public register() {
        ...
        this.accountService.register(this.account).subscribe(a => {
            if(a) {
