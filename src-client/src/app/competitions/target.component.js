...
var TargetComponent = /** @class */ (function () {
    ...
    Object.defineProperty(TargetComponent.prototype, "distances", {
        get: function () {
            return lodash_1.default.uniq(this.target.distances).map(function (d) { return d + "m"; }).join(" / ");
        },
        enumerable: true,
        configurable: true
    });
    ...
    TargetComponent.prototype.affectCompetitorToPositionning = function (i, event) {
