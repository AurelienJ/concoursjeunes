...
CREATE TABLE NIVEAU_COMPETITION (
		...
		ID_LIBELLE		UUID,
		DEFAUT			BOOLEAN,
		PRIMARY KEY (CODENIVEAU, NUMFEDERATION),
...
CREATE TABLE POSSEDE (
		-- Clé de CRITERIASET
		NUMCRITERIASET INTEGER NOT NULL,
		-- Clé de CRITEREELEMENT (3 champs)
		CODECRITEREELEMENT VARCHAR(16) NOT NULL,
		CODECRITERE VARCHAR(16) NOT NULL,
		NUMREGLEMENT INTEGER NOT NULL,
...
CREATE TABLE IF NOT EXISTS ENTITE (
		...
		UPPER_VILLEENTITE VARCHAR(64) as UPPER(VILLEENTITE),
...
CREATE INDEX IF NOT EXISTS I_UPPER_VILLE_ENTITE ON ENTITE (UPPER_VILLEENTITE ASC);
