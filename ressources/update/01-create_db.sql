...
CREATE TABLE NOT EXISTS REPARTITION_PHASE_FINALE (
...
CREATE TABLE TYPE_EQUIPE (
		...
		PRIMARY KEY (CODETYPEEQUIPE, ID_FEDERATION, LANG),
...
CREATE TABLE IF NOT EXISTS CRITERE_CLASSEMENT (
		...
		ID_REGLEMENT				UUID, --Si Critere equipe
		ID_JEUX_DISTANCES_BLASONS	UUID, --Si Critere individuel
