...
INSERT INTO ENTITE (ID_ENTITE, NOM, TYPEENTITE, REMOVABLE) VALUES ('db359dbe-79fb-49ed-b607-59127c7ce78b','Fédération Française de Tir à l''Arc',0, 0);
...
CREATE TABLE IF NOT EXISTS ASSOCIER_CATEGORIE_CONTACT (
		ID_CONTACT				UUID NOT NULL,
		ID_CATEGORIE_CONTACT	INTEGER NOT NULL,
...
CREATE TABLE DEPARTAGE (
		ID_DEPARTAGE	NOT NULL DEFAULT RANDOM_UUID(),
		ID_REGLEMENT	UUID NOT NULL, 
