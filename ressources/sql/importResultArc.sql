...
MERGE INTO ARCHERS (ID_CONTACT,NUMLICENCEARCHER, 
    ...
    ARC, DATEMODIF) SELECT A.ID_CONTACT,NUMLICENCEARCHER, 
        CERTIFMEDICAL, GENREARCHER, null, 
        CATEGORIEARCHER, NIVEAUARCHER, ARCARCHER-1, @DATE_MODIF FROM IMPORTFFTA.ArchersFFTA A INNER JOIN CONTACT C ON A.ID_CONTACT = C.ID_CONTACT;
